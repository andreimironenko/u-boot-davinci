/*
 * Copyright (C) 2011 Hanover Displays Ltd
 *
...
/* Hanover Displays TMS320DM365 HTC */
#define DAVINCI_DM365HTC
...
#define CONFIG_MUSB_DISABLE_HIGHSPEED
...
#define CONFIG_SYS_PROMPT	"DM36x HTC # "	/* Monitor Command Prompt */
...
#define CONFIG_ENV_OFFSET	(1912 << 9)	/* Sector 1912 */
...
#define CONFIG_BOOTDELAY	3
#define CONFIG_BOOTCOMMAND	"ext2load mmc 0 0x80700000 boot/uImage; bootm 0x80700000"
#define CONFIG_BOOTARGS \
		"console=ttyS0,115200n8 " \
		"root=/dev/mmcblk0p1 rw rootwait rootfstype=ext2 ip=off " \
...
#define CONFIG_SYS_BARGSIZE	2048			/* bootarg Size */
...
#define CONFIG_SYS_MMC_BOOTCOUNT_DEV	0
#define CONFIG_BOOTCOUNT_OFFSET			(918 << 9)	/* Sector 918 */
