...
/* Memory Info */
/*=============*/
#define CONFIG_SYS_MALLOC_LEN		(0x80000 + 1024 * 1024)	/* malloc() len was 0x40000*/
...
#define CONFIG_STACKSIZE	(1024 * 1024)	/* regular stack doubled to 2048 each */
...
#define CONFIG_BOOTARGS		"mem=96M console=ttyS0,115200n8 root=/dev/mtdblock4 rw rootfstype=jffs2 ip=off video=davincifb:vid0=OFF:vid1=OFF:osd0=720x576x16,2025K"
